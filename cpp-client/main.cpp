...
//
//    for (int i = 0;i<100;i++) {
//        ThinkingAnalyticsAPI::Track("test_event_16",json);
//    }
...
////        ThinkingAnalyticsAPI::Track("test_event_16",json);
////    }
//    TDFirstEvent *firstEvent = new TDFirstEvent("firstEvent", json);
//    firstEvent->setFirstCheckId("1");
//    //ThinkingAnalyticsAPI::Track(firstEvent);
//    ThinkingAnalyticsAPI::Track("78");
//
