...
void thinkingdata::ta_mac_tool::updateSuperproperty(const char *token, const char *superproperty)
{
...
const char * thinkingdata::ta_mac_tool::loadSuperproperty(const char *token) {
